		...
		<div id="container-or" class="container-md">
			<div class="my-5 py-5">
				<input type="checkbox" id="zoomCheck">
					<label id="swolezoom" for="zoomCheck">
						<img src="${pageContext.request.contextPath}/resources/img/swoletics-logo.png" alt="Swoletics logo" class="logo mt-2" />
					</label>
				<h1 class="h1 main-head mt-3">Swoletics</h1>	
				<h2 class="h2">Fitness Tracker</h2>
			</div>
			<div class="pt-5 btn-container">
				<button type="button" id="btn-or" class="btn btn-info btn-lg my-4 shadow p-3" data-toggle="modal" data-target="#login">Log In</button>
				<button type="button" id="btn-or" class="btn btn-info btn-lg my-4 shadow p-3" onclick="location.href ='/fitnesstracker/userSetup'">Register</button>
			</div>
		</div>
		  ...
		  <div class="modal-dialog modal-dialog-centered" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="exampleModalCenterTitle">Swoletics - Log In</h5>
