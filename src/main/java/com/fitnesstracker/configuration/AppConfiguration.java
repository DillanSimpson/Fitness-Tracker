...
/*
 *
 * {@link AppConfiguration} is a Java Based Configuration file
 * which is similar to {@link spring-servler.xml}, this has all
 * the configurations required for application
 ...
 * {@link EnableWebMvc} this enables the MVC web configuration
 * {@link EnableSwagger2} Indicates that Swagger support should be enabled.
 * {@link EnableTransactionManager} Enables Spring's annotation-driven
 * transaction management capability
 * {@link ComponentScan} Configures component scanning directives for
 * use with {@link Configuration} classes
 * {@link WebMvcConfigurer} Defines callback methods to customize
 * the Java-based configuration for Spring MVC
 *
 */
@Configuration
@EnableWebMvc
...
public class AppConfiguration implements WebMvcConfigurer {
   ...
   * automated controllers pre-configured with status code and/or a view. It
   * is similar to welcome page in web.xml
   */
  @Override
  ...
  /*
   * Intended to be used when the Spring MVC {@link DispatcherServlet} is
  ...
  /*
   * {@link ViewResolver} The view class for all views generated by resolver
   * can be specified
   */
  @Bean
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
    ...
    localContainerEntityManagerFactoryBean.setPackagesToScan(
        new String[] {"com.fitnesstracker.model"});
  ...
  /*
   * {@link JPATransactionManager} Binds a JPA EntityManager from the
   ...
   * org.springframework.stereotype.Repository Repository} annotation, adding
   * a corresponding {@link PersistenceExceptionTranslationAdvisor} to the
  ...
  /*
   * {@link LocaleResolver} bean used to Set a default Locale that this
   ...
   *
   * @return {@link Docket} used to build a subset of the services to be
   * displayed for Swagger documentation
   */
  @Bean(name = "SwaggerUI")
  public Docket swaggerApi() {
    return new Docket(DocumentationType.SWAGGER_2)
        .select()
        .apis(RequestHandlerSelectors.basePackage("com.fitnesstracker.controller"))
