...
public class UserDataDaoImpl implements UserDataDao {
	...
	private static final String GET_USERS_QUERY_SORTED_ASC = "SELECT u FROM UserData u ORDER BY u.associateID asc";
	private static final String GET_USERS_QUERY_SORTED_DESC = "SELECT u FROM UserData u ORDER BY u.associateID desc";
