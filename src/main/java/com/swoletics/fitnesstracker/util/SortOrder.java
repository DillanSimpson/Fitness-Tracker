...
/**
 * Values that are used to signify the type of sort order used in database
 * queries.
 *
...
public enum SortOrder {
	 ...
	 *
	 * @param sortOrder the enum to check if it is valid or not. It must not be
	 *                  blank or {@code null}. If it is either blank or
	 *                  {@code null}, then it will be considered an invalid enum.
	 * @return the enum that represents {@code sortOrder} if it is a valid enum.
	 *         Otherwise, it will return a default enum of {@code ASC} if
	 *         {@code sortOrder} is not valid or it is blank or {@code null}.
	 */
