...
CREATE TABLE users (user_id int, user_name varchar(255), password varchar(255), member_type int, role varchar(255), active boolean);
CREATE TABLE users_data (user_id int, first_name varchar(255), last_name varchar(255), email varchar(255), age int, sex varchar(255),
 ...
 protein_min int, workout_frequency int, plan_id int, workout_id int);
...
INSERT INTO `fitnesstracker`.`users_data` (`user_id`, `first_name`, `last_name`, `email`, `age`, `sex`, `height`, `weight`, `calories_max`, `calories_min`, `carbs_max`, `fat_max`, `sugar_max`, `protein_max`, `protein_min`, `workout_frequency`, `plan_id`, `workout_id`) VALUES ('1', 'Joe', 'Goldberg', 'joe.goldberg@gmail.com', '27', 'MALE', '72',  '185', '1600', '1100', '60',  '35', '30', '100', '66', '5', '1', '1');
INSERT INTO `fitnesstracker`.`users_data` (`user_id`, `first_name`, `last_name`, `email`, `age`, `sex`, `height`, `weight`, `calories_max`, `calories_min`, `carbs_max`, `fat_max`, `sugar_max`, `protein_max`, `protein_min`, `workout_frequency`, `plan_id`, `workout_id`) VALUES ('2', 'Love', 'Quinn', 'love.quinn@gmail.com', '26', 'FEMALE', '66', '130', '1400', '1000', '44', '33', '22', '70', '44', '4', '2', '2');
...
INSERT INTO `fitnesstracker`.`users` (`user_id`, `user_name`, `password`, `member_type`, `role` , `active`) VALUES ('1', 'jgoldberg', 'killer', '1', 'USER', '1');
INSERT INTO `fitnesstracker`.`users` (`user_id`, `user_name`, `password`, `member_type`, `role` , `active`) VALUES ('2', 'lquinn', 'killer', '1', 'USER', '1');
